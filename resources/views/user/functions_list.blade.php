                        ...
                        <form>
                            ...
                            <div class="form-group col-md-12 m-t-15">
                                ...
                                <div
                                    ...
                                    <input type="text" class="form-control " placeholder="Nom du fonction..."
                            ...
                            <div class="form-group col-md-6 m-t-15">
                                ...
                                <div
                                    :class="[errors.category ? '  input-group input-group-danger' :
                                        ' input-group input-group-inverse'
                                    ]">
                                    <select id="categories" class="selectpicker show-tick text-center"
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" title="{{ $category->number }}">
                            ...
                            <div class="form-group col-md-6 m-t-15">
                                ...
                                <div
                                    :class="[errors.section ? '  input-group input-group-danger' :
                                        ' input-group input-group-inverse'
                                    ]">
                                    <select id="sections" class="selectpicker show-tick text-center" title="Se rendre à..."
                                        data-width="100%" v-model='section_id' data-live-search="true"
                                        data-style="btn-default">
                                        @foreach ($sections as $section)
                                            <option value="{{ $section->id }}" title="{{ $section->number }}">
                            ...
                            <li>
                                <span data-toggle="modal" data-target="#fonction-modal">
                                    <i class="fa fa-plus faa-horizontal animated text-success " data-toggle="tooltip"
                                        data-placement="top" data-original-title="Ajouter un fonction"
                                ...
                                <tr v-for="(fonction, index) in fonctions">
                                    ...
                                    <td style="width:20px">
                                        <div class="text-center">
                                            <span data-toggle="modal" data-target="#fonction-modal"
                                                v-on:click="edit_fonction(fonction,index)">
                                            ...
                                            <i class="feather icon-trash text-danger f-18 clickable"
                                                v-on:click="delete_fonction(fonction.id,index)" data-toggle="tooltip"
