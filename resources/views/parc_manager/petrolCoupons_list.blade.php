                    ...
                    <div class="col-md-12 ">
                        <form>
                            <div class="row" id="add-petrolCoupon-form">
                                ...
                                <div class="form-group col-md-6 m-t-15">
                                    <label for="drivers" class="block">Chauffeur <span class="text-danger">
                                            (*)</span></label>
                                ...
                                <div class="form-group col-md-5 ">
                                    <label for=kilometrage" class="block">DERNIER KILOMTRAGE <span
                                            class="text-danger">(*)</span></label>
                                    <div
                                        :class="[errors.kilometrage ? '  input-group input-group-danger' :
                                            ' input-group input-group-inverse'
                                        ]">
                                        <input type="number" class="form-control " placeholder="Kilométrage..."
                                            data-toggle="tooltip" data-placement="top"
                                            :data-original-title="errors.kilometrage" v-model="kilometrage" min="0">
                                        <span class="input-group-addon">
                                ...
                                <div class="form-group col-md-7 ">
                                    <label for="card-number" class="block">Date d'attribution<span class="text-danger">
                                            (*)</span></label>
                                    <div
                                        :class="[errors.assigned_at ? ' input-group input-group-danger' :
                                            ' input-group input-group-inverse'
                                        ]">
                                ...
                                <div class="form-group col-md-12 demo-wrapper" id="simple-clone">
                                    <label for="coupon_number" class="block">NUMERO DU BON <span
                                            class="text-danger">(*)</span></label>
                                    <div class="input-group input-group-inverse toclone">
                                        <span class="input-group-addon delete">
                                            <b class="fa fa-minus"></b>
                                        </span>
                                        <input type="text" class="form-control coupons" placeholder="Numéro du bon..."
                                            data-toggle="tooltip" data-placement="top"
                                            :data-original-title="errors.coupon_number" min="0">
                    ...
                    <form class="row">
                        <div class="form-group col-md-4 ">
                            ...
                            <div class="input-group input-group-inverse">
                                <select id="f-vehicles" class="selectpicker show-tick text-center"
                                    title="Sélectionner un véhicule.." data-width="100%">
                        ...
                        <div class="form-group col-md-4 ">
                            ...
                            <div class="input-group input-group-inverse">
                                <select id="f-drivers" class="selectpicker show-tick text-center"
                                    title="Sélectionner un chauffeur.." data-width="100%">
                        ...
                        <ul class="list-unstyled card-option">
                            <li>
                                <span data-toggle="tooltip" data-placement="top"
                                    data-original-title="Ajouter une attribution">
                                    <i class="fa fa-plus faa-horizontal animated text-success " style="font-size:22px"
                                        data-toggle="modal" data-target="#petrolCoupon-modal"
                        ...
                        <table id="petrolCoupons-table" class="table  table-bordered nowrap">
                            ...
                            <tbody>
                                <tr v-for="(petrolCoupon, index) in petrolCoupons">
                                    ...
                                    <td class="text-center" style="width:200px">@{{ petrolCoupon.vehicle.model.name.toUpperCase() + ' - ' + petrolCoupon.vehicle.licence_plate }}</td>
                                    ...
                                    <td style="width:70px">
                                        <div class="text-center">
                                            <span data-toggle="modal" data-target="#petrolCoupon-modal"
                                                v-on:click="edit_petrolCoupon(petrolCoupon,index)">
                                            ...
                                            <i class="feather icon-trash text-danger f-18 clickable"
                                                v-on:click="delete_petrolCoupon(petrolCoupon.id,index)"
                                                data-toggle="tooltip" data-placement="top"
                        ...
                        initComplete: function() {
                            this.api().columns([2]).every(function() {
                                ...
                                column.data().unique().sort().each(function(d, j) {
                                    $('#f-drivers').append('<option value="' + d +
                                        '">' + d + '</option>')
                                });
                            });
                            this.api().columns([1]).every(function() {
                                ...
                                column.data().unique().sort().each(function(d, j) {
                                    $('#f-vehicles').append('<option value="' + d +
                                        '">' + d + '</option>')
                                });
                            });
