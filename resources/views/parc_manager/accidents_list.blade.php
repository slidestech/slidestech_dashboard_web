...
@section('page_content')
                        ...
                        <form>
                            <div class="row" id="add-accident-form">
                                ...
                                <div class="form-group col-md-4 m-t-15">
                                    <label for="card-number" class="block">Date d'accident<span class="text-danger">
                                            (*)</span></label>
                                    <div
                                        :class="[errors.bought_at ? ' input-group input-group-danger' :
                                            ' input-group input-group-inverse'
                                        ]">
                                        <input id="occured_at" type="text" class="form-control date text-center"
                                            placeholder="Date d'accident..." data-toggle="tooltip" data-placement="top"
                                            :data-original-title="errors.bought_at">
                                        <span class="input-group-addon">
                                ...
                                <div class="form-group col-md-8 m-t-15">
                                    <label for=location" class="block">Lieu d'accident <span
                                            class="text-danger">(*)</span></label>
                                    <div
                                        :class="[errors.location ? '  input-group input-group-danger' :
                                            ' input-group input-group-inverse'
                                        ]">
                                        <input type="text" class="form-control " placeholder="Lieu d'accident..."
                                ...
                                <div class="form-group col-md-12 m-t-15">
                                    <label for=details" class="block">Détails de l'accident <span
                                            class="text-danger">(*)</span></label>
                                    <div
                                        :class="[errors.details ? '  input-group input-group-danger' :
                                            ' input-group input-group-inverse'
                                        ]">
                                        <input type="text" class="form-control " placeholder="Détails de l'accident..."
                                ...
                                <div class="form-group col-sm-6">
                                    <label for="-date" class="block">Constat de l'accident <span class="text-danger">(*)
                                        </span></label>
                                    <div :class="[errors.report_file ? '  input-group input-group-danger' :
                                        ...
                                        <input id="report-file" name="reportfile" type="text"
                                            class="form-control bg-white" placeholder="Constat d'accident scanné..."
                                            data-toggle="tooltip" data-placement="top"
                                ...
                                <div class="form-group col-sm-6 form-group-danger" style="display:none">
                                    <label for="reportfile" class="block">Constat de l'accident <span
                                            class="text-danger">(*) </span></label>
                                    <div :class="[errors.report_file ? 'input-group input-group-danger' :
                                        'input-group input-group-inverse'
                                    ]"
                        ...
                        <ul class="list-unstyled card-option">
                            <li>
                                <span data-toggle="tooltip" data-placement="top"
                                    data-original-title="Ajouter un accident">
                                    <i class="fa fa-plus faa-horizontal animated text-success " style="font-size:22px"
                                        data-toggle="modal" data-target="#accident-modal" v-on:click="operation='add'">
                                    </i>
                                </span>
                            </li>
                        </ul>
    ...
    accident.vehicle.model.name.toUpperCase() + ' - ' + accident.vehicle.licence_plate }}</td>
                                    ...
                                    <td class="text-left" style="width:100px;white-space:normal;">@{{ accident.details.toUpperCase() }}
                                    </td>
                                    <td class="text-center" style="width:100px">
                                        <a :href="'storage/' + accident.report_url" target="_blank"
                                    ...
                                    <td style="width:70px">
                                        <div class="text-center">
                                            <span data-toggle="modal" data-target="#accident-modal"
                                                v-on:click="edit_accident(accident,index)">
                                            ...
                                            <i class="feather icon-trash text-danger f-18 clickable"
                                                v-on:click="delete_accident(accident.id,index)" data-toggle="tooltip"
