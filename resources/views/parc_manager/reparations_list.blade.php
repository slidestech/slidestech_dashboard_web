...
@section('page_content')
                        ...
                        <form>
                            <div class="row" id="add-reparation-form">
                                ...
                                <div class="form-group col-md-6 m-t-15">
                                    ...
                                    <div
                                        :class="[errors.total ? '  input-group input-group-danger' :
                                            ' input-group input-group-inverse'
                                        ]">
                                        <input type="number" class="form-control " placeholder="Coût..."
                                            data-toggle="tooltip" data-placement="top" :data-original-title="errors.total"
                                            v-model="total" min="0">
                                        <span class="input-group-addon">
                                            <b class="fa fa-money"></b>
                                        </span>
                                ...
                                <div class="form-group col-md-6 m-t-15">
                                    ...
                                    <div
                                        ...
                                        <input id="started_at" type="text" class="form-control date text-center"
                                            placeholder="Date du réparation..." data-toggle="tooltip" data-placement="top"
                        ...
                        <ul class="list-unstyled card-option">
                            <li>
                                <span data-toggle="tooltip" data-placement="top"
                                    data-original-title="Ajouter une réparation">
                                    <i class="fa fa-plus faa-horizontal animated text-success " style="font-size:22px"
                                        data-toggle="modal" data-target="#reparation-modal" v-on:click="operation='add'">
                                    </i>
                                </span>
                            </li>
                        </ul>
    ...
    reparation.vehicle.model.name.toUpperCase() + ' - ' + reparation.vehicle.licence_plate }}</td>
                                    ...
                                    <td class="text-left" style="width:100px;white-space:normal;">@{{ reparation.details.toUpperCase() }}
                                    </td>
                                    <td class="text-center" style="width:200px">@{{ reparation.total }}</td>
                                    <td style="width:70px">
                                        <div class="text-center">
                                            <span data-toggle="modal" data-target="#reparation-modal"
                                                v-on:click="edit_reparation(reparation,index)">
                                            ...
                                            <i class="feather icon-trash text-danger f-18 clickable"
                                                v-on:click="delete_reparation(reparation.id,index)" data-toggle="tooltip"
