...
@section('page_content')
                    ...
                    <div class="col-md-12 ">
                        <form>
                            <div class="row" id="add-maintenance-form">
                                ...
                                <div class="form-group col-md-12 m-t-15">
                                    <label for="-date" class="block">Mécanicien <span class="text-danger">
                                            (*)</span></label>
                                    <div :class="[errors.mechanic_id ? '  input-group input-group-danger' :
                                        '  input-group input-group-inverse'
                                    ]"
                                        data-toggle="tooltip" data-placement="top"
                                        :data-original-title="errors.mechanic_id">
                                        <select id="mechanics" class="selectpicker show-tick text-center"
                                            title="Sélectionner un mécanicien.." data-width="100%">
                                ...
                                <div class="form-group col-md-12 m-t-15">
                                    <label for="maintenance-types" class="block">Type d'entretiens <span
                                            class="text-danger"> (*)</span></label>
                                    <div :class="[errors.maintenanceType ? '  input-group input-group-danger' :
                                        '  input-group input-group-inverse'
                                    ]"
                                        data-toggle="tooltip" data-placement="top"
                                        :data-original-title="errors.maintenanceType">
                                        <select id="maintenance-types" class="selectpicker show-tick text-center"
                                            title="Sélectionner un entretien.." data-width="100%" multiple>
                                ...
                                <div class="form-group col-md-6 m-t-15">
                                    ...
                                    <div
                                        ...
                                        <input id="started_at" type="text" class="form-control date text-center"
                                            placeholder="Date du entretien..." data-toggle="tooltip" data-placement="top"
                            ...
                            <li>
                                <span data-toggle="modal" data-target="#maintenance-modal">
                                    <i class="fa fa-plus faa-horizontal animated text-success " data-toggle="tooltip"
                                        data-placement="top" data-original-title="Ajouter un entretien"
    ...
    maintenance.vehicle.model.name.toUpperCase() + ' - ' + maintenance.vehicle.licence_plate }}</td>
                                    ...
                                    <td class="text-left" style="width:100px;white-space:normal;">@{{ maintenance.details.toUpperCase() }}
                                    </td>
                                    <td class="text-center" style="width:200px">@{{ maintenance.cost }}</td>
                                    <td style="width:70px">
                                        <div class="text-center">
                                            <span data-toggle="modal" data-target="#maintenance-modal"
                                                v-on:click="edit_maintenance(maintenance,index)">
                                            ...
                                            <i class="feather icon-trash text-danger f-18 clickable"
                                                v-on:click="delete_maintenance(maintenance.id,index)"
                                                data-toggle="tooltip" data-placement="top"
